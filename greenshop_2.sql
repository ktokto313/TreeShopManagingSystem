...
VALUES (5, 'ORDER_STATUS', 'Đơn hàng đang được giao',
        'Đơn hàng #1 của bạn đang được giao đến địa chỉ 123 Nguyễn Trãi, Quận 1, TP.HCM', 1),
       (6, 'ORDER_STATUS', 'Đơn hàng đang được giao',
        'Đơn hàng #2 của bạn đang được giao đến địa chỉ 45 Lê Lợi, Quận Hải Châu, Đà Nẵng', 2),
