...
public class Notification {
    ...
    public boolean isSentViaEmail() { return sentViaEmail; }
    public void setSentViaEmail(boolean sentViaEmail) { this.sentViaEmail = sentViaEmail; }

    public boolean isEmailSendFailed() { return emailSendFailed; }
    public void setEmailSendFailed(boolean emailSendFailed) { this.emailSendFailed = emailSendFailed; }
